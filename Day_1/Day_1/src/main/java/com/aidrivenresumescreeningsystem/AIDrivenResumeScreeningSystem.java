...
public class AIDrivenResumeScreeningSystem {
    public static void main(String[] args) {
        Resume<SoftwareEngineer> seResume = new Resume<>(new SoftwareEngineer("deep", 3));
        Resume<DataScientist> dsResume = new Resume<>(new DataScientist("ankit", 5));
        ...
        applicants.add(new SoftwareEngineer("Mohan", 4));
        applicants.add(new DataScientist("Suresh", 6));
        applicants.add(new ProductManager("Monu", 8));
